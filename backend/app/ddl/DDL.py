...
(1, '2025-12-15 14:00:00', '석장동', '스타벅스 석장점', '주말 카페 스터디', '같이 카페에서 공부하실 분 구합니다!', 2, 6),
(2, '2025-12-20 19:00:00', '성건동', '청년다방', '저녁 맛집 탐방', '맛집 같이 다니실 분 환영합니다.', 3, 8),
(3, '2025-12-25 10:00:00', '황성동', '황성공원', '아침 러닝 모임', '새벽 러닝 같이해요!', 5, 10),
(1, '2025-12-16 15:00:00', '용강동', '용강체육관', '배드민턴 동아리', '배드민턴 치실 분 구합니다', 4, 8),
(2, '2025-12-18 18:00:00', '보문동', '보문호수 둘레길', '저녁 산책 모임', '보문호수 산책하실 분', 2, 6),
(3, '2025-12-22 13:00:00', '충효동', '챔피언당구클럽', '당구 치실 분', '당구 실력 무관! 같이 치며 친해져요', 2, 4),
(1, '2025-12-17 16:00:00', '석장동', '프리미엄PC방', 'LOL 게임 모임', '롤 같이 하실 분! 티어 무관', 4, 5),
(2, '2025-12-19 20:00:00', '성건동', '코인노래방', '노래방 가실 분', '스트레스 풀러 노래방 가요', 3, 6),
(3, '2025-12-23 14:00:00', '황성동', '황성도서관', '시험기간 스터디', '같이 공부하면서 응원해요', 3, 8),
(1, '2025-12-24 11:00:00', '용강동', 'CGV 경주', '크리스마스 영화 관람', '크리스마스 영화 같이 봐요', 2, 5),
(2, '2025-12-26 17:00:00', '보문동', '보문아트홀', '전시회 관람', '보문단지 전시회 같이 가실 분', 2, 4),
(3, '2025-12-27 19:00:00', '충효동', 'BBQ치킨 충효점', '치킨 파티', '치킨 먹으면서 수다 떨어요', 4, 8),
(1, '2025-12-28 10:00:00', '석장동', '석장피트니스', '아침 운동 모임', '헬스 같이 하실 분!', 2, 6),
(2, '2025-12-29 15:00:00', '성건동', '투썸플레이스', '영어 회화 스터디', '영어로 자유롭게 대화해요', 3, 6),
(3, '2025-12-30 13:00:00', '황성동', '황성풋살장', '풋살 모임', '풋살 같이 하실 분 구합니다', 8, 12),
(1, '2026-01-02 14:00:00', '용강동', '용강볼링센터', '볼링 치실 분', '볼링 초보도 환영!', 4, 8),
(2, '2026-01-03 18:00:00', '보문동', '보문호수 자전거길', '자전거 라이딩', '보문호수 자전거 투어', 3, 6),
(3, '2026-01-04 16:00:00', '충효동', '포켓볼클럽', '포켓볼 모임', '당구 좋아하시는 분들 모여요', 2, 4),
(1, '2026-01-05 12:00:00', '석장동', '카페베네', '독서 모임', '책 읽고 이야기 나눠요', 3, 6),
(2, '2026-01-06 19:00:00', '성건동', '경주한옥마을', '저녁 회식', '맛있는 저녁 같이 먹어요', 4, 8),
(4, '2026-01-07 15:00:00', '황성동', '스터디룸', '자격증 스터디', '자격증 공부 같이 해요', 2, 6),
(5, '2026-01-08 18:00:00', '석장동', '동해루', '중식 맛집 탐방', '짬뽕 좋아하시는 분!', 3, 6),
(6, '2026-01-09 10:00:00', '용강동', '용강근린공원', '요가 클래스', '아침 요가 같이 해요', 4, 10),
(7, '2026-01-10 20:00:00', '성건동', '할매떡볶이', '떡볶이 파티', '매운 떡볶이 도전!', 3, 8),
(8, '2026-01-11 14:00:00', '보문동', '보문호수 테라스카페', '사진 촬영 모임', '카메라 들고 사진 찍어요', 2, 5),
(4, '2026-01-12 16:00:00', '충효동', '코믹스펀', '만화 읽기 모임', '만화책 같이 읽어요', 2, 4),
(5, '2026-01-13 19:00:00', '황성동', '이자카야 사쿠라', '회식 모임', '술한잔 하실 분!', 4, 8),
(6, '2026-01-14 11:00:00', '석장동', '파리바게트', '베이킹 클래스', '쿠키 만들기 체험', 3, 6),
(7, '2026-01-15 13:00:00', '용강동', '용강탁구클럽', '탁구 동아리', '탁구 치실 분 구합니다', 4, 8),
(8, '2026-01-16 17:00:00', '성건동', '교보문고', '책 추천 모임', '좋은 책 공유해요', 2, 6),
(4, '2026-01-17 15:00:00', '보문동', '보문미술관', '미술 감상', '미술 작품 같이 봐요', 2, 5),
(5, '2026-01-18 12:00:00', '충효동', '왕족발', '족발 맛집', '족발 좋아하시는 분!', 3, 8),
(6, '2026-01-19 10:00:00', '황성동', '황성근린공원', '아침 산책', '산책하며 대화해요', 2, 6),
(7, '2026-01-20 18:00:00', '석장동', '황금찜질방', '찜질방 힐링', '찜질방에서 쉬어요', 3, 6),
(8, '2026-01-21 14:00:00', '용강동', '미스터리방', '방탈출 도전', '방탈출 같이 해요!', 4, 6),
(4, '2026-01-22 16:00:00', '성건동', '보드게임천국', '보드게임 모임', '보드게임 좋아하시는 분', 3, 6),
(5, '2026-01-23 19:00:00', '보문동', '경주한정식', '한식 맛집', '삼겹살 먹으러 가요', 4, 8),
(6, '2026-01-24 11:00:00', '충효동', '충효테니스클럽', '테니스 모임', '테니스 치실 분!', 4, 8),
(7, '2026-01-25 13:00:00', '황성동', '커피빈', '코딩 스터디', 'Python 같이 공부해요', 3, 6),
(8, '2026-01-26 17:00:00', '석장동', '스시로', '초밥 맛집 탐방', '초밥 좋아하시는 분', 3, 6);
